...
#
# else:
#     path = "../Data_Generation/Gan_Data/Gan_0_dBIndoor2p4_64ant_32users_8pilot_re.mat"
#     # optimizer
#     lr_gen = 0.001
#     lr_dis = 2e-5
#     beta1 = 0.9
...
# lr_dis = 0.0001
# generator_optimizer = tf.compat.v1.train.AdamOptimizer(lr_gen, beta1=0.5)
# discriminator_optimizer = tf.compat.v1.train.RMSPropOptimizer(lr_dis)
...
if __name__ == "__main__":
    ...
    # lr_gen_list = [1e-4, 1.25e-4, 1.5e-4, 1.75e-4, 2e-4, 2.25e-4, 2.5e-4, 2.75e-4, 3e-4];
    # beta1_list = [0.7, 0.9]
    nm_val_list = [];
    ...
    # plt.xlabel('Epoch')
    # plt.ylabel('NMSE (dB)')
    # plt.title("Epoch - NMSE Score, [lr : %.6f] [beta1 : %.3f]" % (lr_gen, beta1))
    # plt.grid(True)
    # # plt.show();
